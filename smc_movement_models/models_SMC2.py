...
def run_smc2(window, N=10, **kwargs):
    global fenetre
    fenetre = window
...
def estimate_a1_a2_on_window(window, N=500, M=10, epsilon=0.1, alpha=0.5, sigma = [0.5,0.5]):
    final_a1s = []
    final_a2s = []
    for m in range(M):
...
def estimate_a1_a2_on_window_SMC2(window , N = 10, epsilon = 0.1):
    final_a1s = []
    final_a2s = []
